...
\begin{center} \includegraphics[#1]{img/#2} \end{center}}
...
\textsc{Monsieur \textbf{Pierre-Henri Morille}, voulez-vous prendre pour légitime épouse Élisabeth de Saint-Jean, ici présente, selon le rite de notre mère la Sainte Église?}
  
\emph{\rubrum Le fiancé répond : }\textsc{Oui, je le veux.}

\emph{\rubrum Puis, s'adressant à la fiancée :}
  \textsc{Mademoiselle \textbf{Élisabeth de Saint-Jean}, voulez-vous prendre pour légitime époux Pierre-Henri Morille, ici présent, selon le rite de notre mère la Sainte Église?}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter[Messe de mariage]{\centering Messe de mariage}
...
\includegraphics[width=5cm]{img/consecration20.pdf}
...
\includegraphics[width=5cm]{img/03preparatioAdMissam.jpg}
