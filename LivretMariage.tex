...
\version{\textit{Tout de suite après le \emph{Pater}, le prêtre se tourne vers les nouveaux mariés et lit en latin les oraisons suivantes~:}}
...
\rubrica{Avant de bénir les fidèles, le pr^être donne une bénédiction spéciale à la nouvelle épouse}
