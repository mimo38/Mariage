...
\textsc{Monsieur \textbf{N…}, voulez-vous prendre pour légitime épouse N…, ici présente, selon le rite de notre mère la Sainte Église?}
  
\emph{\rubrum Le fiancé répond : }\textsc{Oui, je le veux.}

\emph{\rubrum Puis, s'adressant à la fiancée :}
  \textsc{Mademoiselle \textbf{N…}, voulez-vous prendre pour légitime époux N…, ici présent, selon le rite de notre mère la Sainte Église?}
