...
\textsc{Monsieur \textbf{Pierre-Henri Morille}, voulez-vous prendre pour légitime épouse Élisabeth de Saint-Jean Le Provost, ici présente, selon le rite de notre mère la Sainte Église?}
  
\emph{\rubrum Le fiancé répond : }\textsc{Oui, je le veux.}

\emph{\rubrum Puis, s'adressant à la fiancée :}
  \textsc{Mademoiselle \textbf{Élisabeth de Saint-Jean Le Provost}, voulez-vous prendre pour légitime époux Pierre-Henri Morille, ici présent, selon le rite de notre mère la Sainte Église?}
...
\subsection{Action de gr^âces}
\cantus{Psaume}{Intonation-Magnificat-6-royal.gabc}{5.}{}
