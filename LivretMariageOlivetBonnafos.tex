...
\textsc{Monsieur \textbf{Sébastien Olivet}, voulez-vous prendre pour légitime épouse Colette de Bonnafos, ici présente, selon le rite de notre mère la Sainte Église?}
  
\emph{\rubrum Le fiancé répond : }\textsc{Oui, je le veux.}

\emph{\rubrum Puis, s'adressant à la fiancée :}
  \textsc{Mademoiselle \textbf{Colette de Bonnafos}, voulez-vous prendre pour légitime époux Sébastien Olivet, ici présent, selon le rite de notre mère la Sainte Église?}
...
\versio{Ego conjungo vos in matrimonium, in nomine Patris, et Filii~\crux\ et Spiritus Sancti. Amen.}{Je vous déclare unis par le mariage au nom du Père et du Fils~\crux\ et du Saint Esprit. Ainsi soit-il.}
%\newpage
