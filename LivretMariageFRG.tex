...
\textsc{Monsieur\newline
\textbf{\TextField[name=epoux,defaut=N.,format={var f = this.getField('prenom');
                       f.strokeColor = ['T'];f.fillColor=['T'];
                       f.textFont ='Verdana'
                   }]}\newline
 voulez-vous prendre pour légitime épouse\newline
 \textbf{\TextField[name=epouse,defaut=N.format={var f = this.getField('prenom');
                       f.strokeColor = ['T'];f.fillColor=['T'];
                       f.textFont ='Verdana'
                   }]}\newline
 ici présente, selon le rite de notre mère la Sainte Église?}
