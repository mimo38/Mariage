...
\textsc{Monsieur \textbf{%\epoux
N. }, voulez-vous prendre pour légitime épouse %\epouse
N., ici présente, selon le rite de notre mère la Sainte Église?}
  
\emph{\rubrum Le fiancé répond : }\textsc{Oui, je le veux.}

\emph{\rubrum Puis, s'adressant à la fiancée :}
  \textsc{Mademoiselle \textbf{%\epouse
  N.}, voulez-vous prendre pour légitime époux %\epoux
  N., ici présent, selon le rite de notre mère la Sainte Église?}
